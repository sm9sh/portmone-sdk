...
namespace Worksection\Portmone;

use Worksection\Portmone\entities\Bill;
use Worksection\Portmone\entities\PayOrder;
use Worksection\Portmone\entities\ReturnPage;
use Worksection\Portmone\exceptions\PortmoneException;
